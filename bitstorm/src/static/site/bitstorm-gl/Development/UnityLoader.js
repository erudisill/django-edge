...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3712725;
      var PACKAGE_UUID = '218a85ba-70c6-49a7-bdc3-b94f131df868';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 21796, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(21796, 35668, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(35668, 172588, 0, 0).open('GET', '/level0');
    new DataRequest(172588, 172607, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(172607, 176504, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(176504, 182908, 0, 0).open('GET', '/resources.assets');
    new DataRequest(182908, 217632, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(217632, 2127000, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2127000, 3624372, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3624372, 3685100, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(3685100, 3712725, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
